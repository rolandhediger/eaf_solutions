...
public class RmiFacade implements RmiMovieService, RmiUserService, RmiRentalService {
	...
	@Override
	public List<MovieDTO> getAllMovies() throws RentalServiceException {
	 ...
	 */
	public Long saveOrUpdateMovie(MovieDTO dto) throws RentalServiceException {
	...
	@Override
	public void deleteMovie(Long id) throws RentalServiceException {
		Movie m = movieService.getMovieById(id);
		movieService.deleteMovie(m);
	}

	@Override
	public List<UserDTO> getAllUsers() throws RentalServiceException {
	...
	@Override
	public UserDTO getUserById(Long id) throws RentalServiceException {
	...
	@Override
	public Long saveOrUpdateUser(UserDTO dto) throws RentalServiceException {
		User user = null;
		if (dto.getId() != null) {
	...
	@Override
	public void deleteUser(Long id) throws RentalServiceException {
		User u = userService.getUserById(id);
		userService.deleteUser(u);	
	}

	@Override
	public List<RentalDTO> getAllRentals() throws RentalServiceException {
...
//		// FIXME update rental ist nicht implementiert, d.h. es können nur neue
...
//	}
	...
	@Override
	public void deleteRental(Long id) throws RentalServiceException {
