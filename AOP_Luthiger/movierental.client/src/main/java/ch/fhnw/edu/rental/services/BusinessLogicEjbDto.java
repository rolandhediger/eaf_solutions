...
public class BusinessLogicEjbDto implements BusinessLogic {
	
	private RmiMovieService movieService;
	private RmiUserService userService;
	private RmiRentalService rentalService;

	public BusinessLogicEjbDto() throws Exception {
		InitialContext ctx = new InitialContext();
		movieService = (RmiMovieService) ctx.lookup("movies/RmiFacade!ch.fhnw.edu.rental.service.RmiMovieService");
		userService = (RmiUserService) ctx.lookup("movies/RmiFacade!ch.fhnw.edu.rental.service.RmiUserService");
		rentalService = (RmiRentalService) ctx.lookup("movies/RmiFacade!ch.fhnw.edu.rental.service.RmiRentalService");
	}
